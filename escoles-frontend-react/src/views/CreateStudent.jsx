    ...
    <>
      ...
      <main>
        <section className="content__create">
          <header>
            <h1 className="tlt">Nuevo alumno</h1>
          </header>
          ...
          <form>
            {[
              ...
              <div key={name} className="divInput">
                <p>{label}<span className="mandatory">*</span></p>
                <input
                  type={type}
                  name={name}
                  placeholder={label}
          ...
          <div className="form__divBtn">
            <button type="button" className="secondaryBtn" onClick={() => navigate('/student')}>
              Cancelar
            </button>
